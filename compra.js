...
function productosCarrito() {
    carrito2.map(producto => {
        ...
        <p>${producto.name}</p><p>${producto.price}</p>
...
<p> Nos pondremos en contacto a la brevedad para coordinar su envío a ${direccion.value}</p>
`
swal("Su pedido se ha realizado con exito");
    } else {
        divConfirmacion.innerHTML = `
